...
//         rotationalVelocity = swerveSubsystem.getSwerveDrive().getSwerveController()
//                 .headingCalculate(swerveSubsystem.getHeading().getRadians(), swerveSubsystem.getTargetHeadingInFieldFrame().getRadians());

//         // convert into controller readings
//         double velocityAsPercent = rotationalVelocity / swerveSubsystem.getSwerveDrive().getMaximumChassisVelocity();
...
//         SwerveInputStream driveAutoHeadingAngularVelocity = SwerveInputStream.of(swerveSubsystem.getSwerveDrive(),
//                 leftYSupplier,
//                 leftXSupplier)
...
//         swerveSubsystem.setDefaultCommand(driveFieldOrientedAutoHeadingAnglularVelocity);
//     }
...
//         swerveSubsystem.setDefaultCommand(operatorSwerveDefaulCommand);
//     }
// }
